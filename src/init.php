 ...
 * @since 1.0.0
 */
function blackbird_gutenberg_blocks_cgb_block_assets() { // phpcs:ignore
	// Styles.
	wp_enqueue_style(
		'blackbird_gutenberg_blocks-cgb-style-css', // Handle.
...
add_action( 'enqueue_block_assets', 'blackbird_gutenberg_blocks_cgb_block_assets' );
 ...
 * @since 1.0.0
 */
function blackbird_gutenberg_blocks_cgb_editor_assets() { // phpcs:ignore
	// Scripts.
	wp_enqueue_script(
		'blackbird_gutenberg_blocks-cgb-block-js', // Handle.
	...
	// Styles.
	wp_enqueue_style(
		'blackbird_gutenberg_blocks-cgb-block-editor-css', // Handle.
